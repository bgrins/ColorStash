...
var tinycolor=function(){function v(b){var a={r:255,g:255,b:255},c=1,n=!1;typeof b=="string"&&(b=w(b));if(typeof b=="object"){if(b.hasOwnProperty("r")&&b.hasOwnProperty("g")&&b.hasOwnProperty("b"))a={r:h(b.r,255)*255,g:h(b.g,255)*255,b:h(b.b,255)*255},n=!0;else if(b.hasOwnProperty("h")&&b.hasOwnProperty("s")&&b.hasOwnProperty("v")){var d=b.h,f=b.s;a=b.v;var k,i,o;d=h(d,360);f=h(f,100);a=h(a,100);n=p.floor(d*6);var e=d*6-n;d=a*(1-f);var j=a*(1-e*f);f=a*(1-(1-e)*f);switch(n%6){case 0:k=a;i=f;o=d;break;
case 1:k=j;i=a;o=d;break;case 2:k=d;i=a;o=f;break;case 3:k=d;i=j;o=a;break;case 4:k=f;i=d;o=a;break;case 5:k=a,i=d,o=j}a={r:k*255,g:i*255,b:o*255};n=!0}else b.hasOwnProperty("h")&&b.hasOwnProperty("s")&&b.hasOwnProperty("l")&&(a=x(b.h,b.s,b.l),n=!0);b.hasOwnProperty("a")&&(c=h(b.a,1))}return{ok:n,r:l(255,m(a.r,0)),g:l(255,m(a.g,0)),b:l(255,m(a.b,0)),a:c}}function t(b,a,c){b=h(b,255);a=h(a,255);c=h(c,255);var d=m(b,a,c),g=l(b,a,c),f,k=(d+g)/2;if(d==g)f=g=0;else{var i=d-g;g=k>0.5?i/(2-d-g):i/(d+g);
switch(d){case b:f=(a-c)/i+(a<c?6:0);break;case a:f=(c-b)/i+2;break;case c:f=(b-a)/i+4}f/=6}return{h:f,s:g,l:k}}function x(b,a,c){function d(a,b,c){c<0&&(c+=1);c>1&&(c-=1);if(c<1/6)return a+(b-a)*6*c;if(c<0.5)return b;if(c<2/3)return a+(b-a)*(2/3-c)*6;return a}b=h(b,360);a=h(a,100);c=h(c,100);if(a==0)c=a=b=c;else{var g=c<0.5?c*(1+a):c+a-c*a,f=2*c-g;c=d(f,g,b+1/3);a=d(f,g,b);b=d(f,g,b-1/3)}return{r:c*255,g:a*255,b:b*255}}function u(b,a,c){b=h(b,255);a=h(a,255);c=h(c,255);var d=m(b,a,c),g=l(b,a,c),
f,e=d-g;if(d==g)f=0;else{switch(d){case b:f=(a-c)/e+(a<c?6:0);break;case a:f=(c-b)/e+2;break;case c:f=(b-a)/e+4}f/=6}return{h:f,s:d==0?0:e/d,v:d}}function q(b,a,c){function d(a){return a.length==1?"0"+a:a}return[d(e(b).toString(16)),d(e(a).toString(16)),d(e(c).toString(16))].join("")}function h(b,a){typeof b=="string"&&b.indexOf(".")!=-1&&r(b)===1&&(b="100%");var c=typeof b==="string"&&b.indexOf("%")!=-1;b=l(a,m(0,r(b)));c&&(b*=a/100);if(p.abs(b-a)<1.0E-6)return 1;else if(b>=1)return b%a/r(a);return b}
function w(b){b=b.replace(y,"").replace(z,"").toLowerCase();s[b]&&(b=s[b]);if(b=="transparent")return{r:0,g:0,b:0,a:0};var a;if(a=j.rgb.exec(b))return{r:a[1],g:a[2],b:a[3]};if(a=j.rgba.exec(b))return{r:a[1],g:a[2],b:a[3],a:a[4]};if(a=j.hsl.exec(b))return{h:a[1],s:a[2],l:a[3]};if(a=j.hsla.exec(b))return{h:a[1],s:a[2],l:a[3],a:a[4]};if(a=j.hsv.exec(b))return{h:a[1],s:a[2],v:a[3]};if(a=j.hex6.exec(b))return{r:parseInt(a[1],16),g:parseInt(a[2],16),b:parseInt(a[3],16)};if(a=j.hex3.exec(b))return{r:parseInt(a[1]+
""+a[1],16),g:parseInt(a[2]+""+a[2],16),b:parseInt(a[3]+""+a[3],16)};return!1}var d=function(b,a){if(typeof b=="object"&&b.hasOwnProperty("_tc_id"))return b;if(typeof b=="object"&&(!a||!a.skipRatio))for(var c in b)b[c]===1&&(b[c]="1.0");c=v(b);var d=c.r,g=c.g,f=c.b,h=c.a;return{ok:c.ok,_tc_id:A++,alpha:h,toHsv:function(){return u(d,g,f)},toHsvString:function(){var a=u(d,g,f),b=e(a.h*360),c=e(a.s*100);a=e(a.v*100);return"hsv("+b+", "+c+"%, "+a+"%)"},toHsl:function(){return t(d,g,f)},toHslString:function(){var a=
t(d,g,f),b=e(a.h*360),c=e(a.s*100);a=e(a.l*100);return h==1?"hsl("+b+", "+c+"%, "+a+"%)":"hsla("+b+", "+c+"%, "+a+"%, "+h+")"},toHex:function(){return q(d,g,f)},toHexString:function(){return"#"+q(d,g,f)},toRgb:function(){return{r:e(d),g:e(g),b:e(f)}},toRgbString:function(){return h==1?"rgb("+e(d)+", "+e(g)+", "+e(f)+")":"rgba("+e(d)+", "+e(g)+", "+e(f)+", "+h+")"},toName:function(){return B[q(d,f,g)]||!1}}};d.version="0.4.3";var y=/^[\s,#]+/,z=/\s+$/,A=0,p=Math,e=p.round,l=p.min,m=p.max,r=parseFloat;
d.equals=function(b,a){return d(b).toHex()==d(a).toHex()};d.desaturate=function(b,a){var c=d(b).toHsl();c.s-=(a||10)/100;c.s=l(1,m(0,c.s));return d(c)};d.saturate=function(b,a){var c=d(b).toHsl();c.s+=(a||10)/100;c.s=l(1,m(0,c.s));return d(c)};d.greyscale=function(b){return d.desaturate(b,100)};d.lighten=function(b,a){var c=d(b).toHsl();c.l+=(a||10)/100;c.l=l(1,m(0,c.l));return d(c)};d.darken=function(b,a){var c=d(b).toHsl();c.l-=(a||10)/100;c.l=l(1,m(0,c.l));return d(c)};d.complement=function(b){b=
d(b).toHsl();b.h=(b.h+0.5)%1;return d(b)};d.triad=function(b){var a=d(b).toRgb();return[d(b),d({r:a.b,g:a.r,b:a.g}),d({r:a.g,g:a.b,b:a.r})]};d.tetrad=function(b){var a=d(b).toRgb();return[d(b),d({r:a.b,g:a.r,b:a.b}),d({r:a.b,g:a.g,b:a.r}),d({r:a.r,g:a.b,b:a.r})]};d.splitcomplement=function(b){var a=d(b).toHsv(),c=a.h*360;return[d(b),d({h:(c+72)%360,s:a.s,v:a.v}),d({h:(c+216)%360,s:a.s,v:a.v})]};d.analogous=function(b,a,c){a=a||6;c=c||30;var e=d(b).toHsv();c=360/c;b=[d(b)];e.h*=360;for(e.h=(e.h-(c*
a>>1)+720)%360;--a;)e.h=(e.h+c)%360,b.push(d(e));return b};d.monochromatic=function(b,a){a=a||6;for(var c=d(b).toHsv(),e=[];a--;)e.push(d(c)),c.v+=0.2,c.v%=1;return e};d.readable=function(b,a){var c=d(b).toRgb(),e=d(a).toRgb();return(e.r-c.r)*(e.r-c.r)+(e.g-c.g)*(e.g-c.g)+(e.b-c.b)*(e.b-c.b)>10404};var s=d.names={aliceblue:"f0f8ff",antiquewhite:"faebd7",aqua:"0ff",aquamarine:"7fffd4",azure:"f0ffff",beige:"f5f5dc",bisque:"ffe4c4",black:"000",blanchedalmond:"ffebcd",blue:"00f",blueviolet:"8a2be2",brown:"a52a2a",
...
yellow:"ff0",yellowgreen:"9acd32"},B=function(b){var a={},c;for(c in b)b.hasOwnProperty(c)&&(a[b[c]]=c);return a}(s),j={rgb:RegExp("rgb[\\s|\\(]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))\\s*\\)?"),rgba:RegExp("rgba[\\s|\\(]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))[,|\\s]+((?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?))\\s*\\)?"),
...
hex3:/^([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})$/,hex6:/^([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})$/};return d}();
